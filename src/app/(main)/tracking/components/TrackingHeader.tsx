...
const TrackingHeader = () => (
  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center">
    <div className="flex flex-col">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#42A5F5]">
            <Image
        ...
        {/* Delivery ETA */}
        <div className="flex flex-col">
          <span className="text-xs text-tertiary font-medium">Delivery ETA</span>
