const travelData = [
    { date: "Monday, Arkansas", time: "09:25 AM", activity: "Package Delivered", place: "Arkansas, USA" },
    { date: "Monday, Arkansas", time: "08:13 AM", activity: "Dispatched from NG", place: "Lagos, NG" },
    { date: "Sunday, Lagos", time: "07:12 AM", activity: "Shipped", place: "Lagos, NG" }
  ]
